  ...
  const cvInteraction = {
    ...
    "cv": {
      ...
      "experience": [
        ...
        "• IDEs: VS Code",
        "• Langages: HTML, CSS, SCSS, Vue 2, Vue 3, Typescript, Vuex, Vuetify, Tailwind, Python, PHP, Django",
        ...
        "Localisation: Paris",
        "Description:",
        "Au sein de Bluecoders, j’ai passé une année sur du Vue.js à implémenter des features servant au CRM interne, pour les commerciaux. En binôme avec un développeur back, nous avions aussi créé une feature principale, le pipe jobs, qui a était réalisé from skratch.",
        "• Pipeline construction, maintenance",
        "Technologies:",
        "• Cloud: AWS",
        "• VCS: Git, Github",
        ...
        "• IDEs: VS Code",
        "• Langages: HTML, CSS, SCSS, Vue 2, Vuex, Vuetify, Node.js",
        ...
        "Localisation: Paris",
        "Description:",
        "J’avais pour mission d’agir sur le CRM interne de la société qui était en Ruby On Rails pour intégrer les fonctionnalités permettant l’utilisation des outils de leur logiciel. De plus, j’avais une mission, durant laquelle j’avais apprit le Vue.js, pour réaliser une timeline qui était un projet client.",
        "Technologies:",
        "• VCS: Git, Github",
        "• IDEs: VS Code",
        "• Langages: HTML, CSS, SCSS, Vue, Vuex, Vuetify, Ruby on rails",
        "• Scripting: Bash, Javascript, PowerShell",
